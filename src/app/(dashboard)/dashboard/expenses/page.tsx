...
export const metadata = {
  title: 'Expenses â€” Thennakoon Tours Management System',
}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Operational expense logging, categorisation, and reporting.</p>
      </div>
