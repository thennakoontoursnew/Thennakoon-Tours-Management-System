...
export default function ReceiptPreviewPage({ params }: PageProps) {
  ...
  const handleDownload = async () => {
    ...
    pdfDoc.save(`Receipt-${receipt.receipt_number}.pdf`)
  }
  ...
  if (!receipt) {
    return <div className="p-8 text-center text-xs text-rose-500">Receipt not found.</div>
  }
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-black text-slate-900 dark:text-white">Receipt PDF ({receipt.receipt_number})</h1>
