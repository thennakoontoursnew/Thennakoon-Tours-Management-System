...
export const metadata = {
  title: 'Fleet Tracking â€” Thennakoon Tours Management System',
}
...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-black text-slate-900 dark:text-white">Fleet Tracking</h1>
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Real-time fleet monitoring, route tracking, and utilisation reporting.</p>
      </div>
