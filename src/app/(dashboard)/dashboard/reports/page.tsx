...
export const metadata = {
  title: 'Reports & Analytics â€” Thennakoon Tours Management System',
}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Revenue reports, fleet utilisation, booking analytics, and KPI dashboards.</p>
      </div>
