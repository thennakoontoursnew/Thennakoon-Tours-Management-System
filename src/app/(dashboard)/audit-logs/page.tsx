...
export const metadata = {
  title: 'Audit Logs â€” Thennakoon Tours Management System',
}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">System activity log, user actions, and security event tracking.</p>
      </div>
