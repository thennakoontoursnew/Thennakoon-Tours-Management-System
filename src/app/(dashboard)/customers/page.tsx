...
export const metadata = {
  title: 'Customers â€” Thennakoon Tours Management System',
}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Customer profiles, contact history, and engagement tracking.</p>
      </div>
