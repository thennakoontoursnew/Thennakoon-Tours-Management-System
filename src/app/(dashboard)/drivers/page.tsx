...
export const metadata = {
  title: 'Drivers â€” Thennakoon Tours Management System',
}
...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-black text-slate-900 dark:text-white">Drivers</h1>
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Driver profiles, licensing, availability, and assignment history.</p>
      </div>
