...
export const metadata = {
  title: 'Quotations â€” Thennakoon Tours Management System',
}
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Quotation generation, approval workflow, and client communication.</p>
      </div>
