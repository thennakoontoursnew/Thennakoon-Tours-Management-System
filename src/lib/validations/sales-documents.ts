...
export const quotationSchema = z.object({
  ...
  bank_account_name_snapshot: z.string().optional().nullable(),
  bank_name_snapshot: z.string().optional().nullable(),
  bank_branch_snapshot: z.string().optional().nullable(),
  bank_account_number_snapshot: z.string().optional().nullable(),
  bank_swift_code_snapshot: z.string().optional().nullable(),
  payment_instructions_snapshot: z.string().optional().nullable(),
  ...
  terms_and_conditions_snapshot: z.string().optional().nullable(),
