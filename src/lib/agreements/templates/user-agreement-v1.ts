...
Now it is hereby agreed between The Lessor and The Lessee that in consideration of the parties doing, observing and performing all of the respective terms, conditions, covenants, stipulations and obligations contained in this agreement to be done, observed and performed respectively by either of them, the parties hereto agree as follows:`

export const USER_AGREEMENT_CLAUSES: LegalClause[] = [
  {
    number: '1',
    title: 'HIRE OF VEHICLE',
    content: `Subject to and upon the terms and conditions contained in this Agreement the Lessor shall provide The Vehicle to The lessee on hire and The lessee can use the vehicle as from the {{RENTAL_START}} and during the entirety of the definite and ascertained period of {{RENTAL_PERIOD_DISPLAY}} commencing from {{RENTAL_START}} (Hereinafter referred to as "The Period").`,
  },
  {
    number: '2',
...
(f) Lessee has to bear Rs.15,000/- from every claim which are above minor accidents limit (close number 3d) as insurance companies deducting same for rent a car cover policy (as excess amount).
...
(d) If The Vehicle has suffered damage or excessive wear (reference to delivery inspection/note) and tear as a result of misuse The Lessee shall be liable for the cost incurred by way of additional servicing, maintenance or repair of The Vehicle as a result of such use.
...
1. Lessee can put the vehicle to nearest workshop and get the repair done with writing approval from lessor (E-mail, WhatsApp or etc).
...
(d) The Lessee fails to pay rental within two (2) days of due date described in this agreement. (e) 1 Month Rental (One Month)
...
(D) (a) Upon the termination or expiry of this agreement The Lessee shall forthwith return The Vehicle to The Lessor (same date which agreement expires) at The Lessor's address given above as The Lessor may direct, in good and working condition and at The Lessor's expense and risk. Without prejudice to the foregoing or to The Lessor’s claim for any arrears of rental, any arrears for money due on excess of mileage agreed under clause 2 (c) interest for and breach of the agreement or any other rights hereunder The Lessor may at any time after such termination or expiry of the agreement without notice re-take possession of The Vehicle and for that purpose enter into or upon any land or premises where The Vehicle is or is believed by The Lessor or its agents to be kept.
...
(o) All terms and conditions of original (first) agreement will apply for the replacement car which is provided by lessor (Thennakoon Tours) to lessee in case of accident, breakdowns, services etc.`,
  ...
  {
    number: '11',
    title: 'RENEVAL OF THE AGREEMENT (Applicable to Agreements of three months and over three months)',
    content: `a) Lessor has the exclusive right on the renewal (extent or not to extend) of this agreement. The Lessee should inform the Lessor in writing if the Lessee intends to renew the agreement.

b) The notice of renewal can be sent by registered Post and/or by email (if given) AND renewal message via Whatsapp prior one month to the expiring of this agreement.

c) Further if the Lessee fails and/or neglected to reply or keep silent on the Notice sent by post and/or email and/or whatsapp the lessor considers that as an acceptance of the offer to Renewal by the Lessee for same terms agreed in this agreement.

d) If Lessee has an objection for renewal, he should reply in writing to above given address of the Lessor and/or reply by email or by WhatsApp. (The reply should be send via Registered post or email or WhatsApp)
...
b) The Lessee should any date prior to expiring the agreement inform the intention to extend and renewal of the agreement to the official email address, through WhatsApp or to the official Telephone number of the Lessor.
...
d) The terms and conditions of this agreement will be applicable in the same manner between the parties to this agreement in renewal even a new agreement is not signed.`,
  ...
  },
  {
    number: '14',
    title: 'NOTICE',
    content: `Any notice or demand to be given by either party to the other shall be in writing and delivered to the other party by registered post or such as WhatsApp and or by email.`,
  },
  {
    number: '15',
...
In proving service of any Notice, Summons, Demand, Decree of the court was properly addressed, stamped and posted under the registered cover, or has been served to the address of the other party as appearing herein or such other address as such other party may have given from the time to time duly communicate to the other party.`,
  ...
  },
  {
    ...
    content: `Lessee - The person or a company who takes vehicle on lease from the Thennakoon Tours (Pvt) Ltd Lessor Thennakoon Tours (Pvt) Ltd
