    ...
    items: [
      {
        ...
        enabled: true,
        keywords: ['finance', 'cashflow', 'ledger', 'collections', 'overview'],
      },
      {
        id: 'earnings',
        label: 'Earnings',
      ...
      },
      {
        ...
        requiredRoles: ['owner', 'admin', 'manager', 'booking_staff', 'finance_staff', 'viewer'],
        enabled: true,
        keywords: ['payments', 'transactions', 'collections', 'cashier'],
      },
      {
        id: 'receipts',
        label: 'Receipts',
        ...
        requiredRoles: ['owner', 'admin', 'manager', 'booking_staff', 'finance_staff', 'viewer'],
        enabled: true,
        keywords: ['receipts', 'vouchers', 'proof of payment'],
      },
      {
        id: 'finance_reports',
        ...
        requiredRoles: ['owner', 'admin', 'manager', 'finance_staff', 'viewer'],
        enabled: true,
        keywords: ['reports', 'aging', 'statements', 'customer statement', 'ledger', 'payment methods'],
      },
    ],
  },
  {
